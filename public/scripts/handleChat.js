...
ComfyJS.onChat = function (user, messageContents, flags, self, extra = {}) {
	...
	if (extra.userColor) {
		...
		newMessage.setAttribute(
			// REMINGTON PATCHED --twitch-message-length: ${formattedMessage.length};
			'style',
			`--twitch-sender-color: ${extra.userColor}; --twitch-sender-color-rgb: ${r} ${g} ${b}; --twitch-sender-color-red: ${r}; --twitch-sender-color-green: ${g}; --twitch-sender-color-blue: ${b}; --twitch-sender-color-hsl: ${h} ${saturationPercent} ${lightnessPercent}; --twitch-sender-color-hue: ${h}; --twitch-sender-color-saturation: ${saturationPercent}; --twitch-sender-color-lightness: ${lightnessPercent}; --twitch-message-length: ${formattedMessage.length};`
		);

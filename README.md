# Juste un curieux: The OBS Overlay

## Locally run

```bash
export DEPLOYMENT_ASTRO_BASE_CONFIG="/overlay"
export DEPLOYMENT_ASTRO_SITE_CONFIG="https://localhost:4321"
...
git clone git@github.com:3forges/juste-un-curieux-twitch-overlay.git ${WHERE_I_WORK}
cd ${WHERE_I_WORK}
git checkout master
...
export DEPLOYMENT_ASTRO_BASE_CONFIG="/juste-un-curieux-twitch-overlay"
export DEPLOYMENT_ASTRO_SITE_CONFIG="https://3forges.github.io"
export DEPLOYMENT_ASTRO_BASE_CONFIG=""
export DEPLOYMENT_ASTRO_SITE_CONFIG="https://juste-un-curieux-obs-overlay.pages.dev"
